...
var _default = {
  ...
  methods: {
    ...
    axiosLogin: function axiosLogin(data) {
      var _this = this;
    ...
    deleteThisArray: function deleteThisArray(id) {
      ...
      var array = [];
      this.maindata.forEach(function (i) {
        if (i.id !== id) {
          array.push(i);
        }
      });
...
exports.default = _default;
      ...
      if (typeof $cf571f === 'function') {
        $cf571f = $cf571f.options;
      }
    
        /* template */
        Object.assign($cf571f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c("loginRegister", {
        attrs: { isLogin: _vm.isLogin, loginPage: _vm.loginPage },
        on: {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cf571f', $cf571f);
          } else {
            api.reload('$cf571f', $cf571f);
          }
        }
